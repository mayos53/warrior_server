...
MessageStatus.create([{ id: MESSAGE_STATUS_SUSPICIOUS, internal_name:'Suspicious',display_text:'חשוד'},
					 ...
					 { id: MESSAGE_TYPE_IGNORE, internal_name:'Ignore',display_text:'התעלם'},
					 { id: MESSAGE_TYPE_USER_SELECTED, internal_name:'User Selected',display_text:'בחירת משתמש'},
					 { id: MESSAGE_TYPE_ELECTION, internal_name:'Election',display_text:'בחירות'}])
